  ...
  <div class="activity boxright">
    <div class="filter-container">
      ...
      <el-select
        ...
        class="filter-item"
      >
        <el-option v-for="item in arr" :label="item.text" :value="item.id" :key="item.id"></el-option>
      </el-select>  
      <el-select
