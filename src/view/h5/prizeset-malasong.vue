  ...
  <div class="prizeset boxright">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button size="mini" type="success" v-if="scope.row.PrizeType==2 && scope.row.Status==1 && scope.row.LogisticId==0" @click="handlefafang(scope.row,'发放',true)">
            发放
          </el-button>
          <el-button size="mini" type="success" v-if="scope.row.PrizeType==2 && scope.row.Status==1 && scope.row.LogisticId>0" @click="handleditor(scope.row,'修改',false)">
